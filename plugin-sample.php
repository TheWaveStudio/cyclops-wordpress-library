...
//                ->setFilter('wf_get_image_url')
    ...
    ->addBlockControls('Opzioni', [
      Field::create('colors', 'backgroundColor', 'Background Color')
        ->setAttribute('colors', ['#fff', '#000'])
        ->setAttribute('customColors', true),
      Field::create('checkbox', 'isFullWidth', __('Mostrare a tutto schermo'))
        ->setWidth(50),
    ])
